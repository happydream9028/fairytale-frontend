          ...
          <Col sm={10}>
            <div className="custom-controls-stacked">
              <Form.Check
                ...
                defaultChecked
              />
              <Form.Check type="radio" id="radio2" name="customRadio" label="Second default radio" className="mb-2" />
              <Form.Check type="radio" id="radio3" label="Disabled radio" disabled />
            </div>
          </Col>
        </Form.Group>
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm={10}>
            <Form.Check type="checkbox" id="checkbox" label="Check me out" disabled />
          </Col>
        </Form.Group>
        <Form.Group as={Row} className="mb-3">

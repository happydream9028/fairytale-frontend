...
const Sizes = () => (
  <Card>
    ...
    <Card.Body>
      <Form.Control type="text" placeholder="Large input" size="lg" className="mb-3" />
...
const Radios = () => (
  <Card>
    ...
    <Card.Body>
      ...
      <Form.Group className="mb-2">
        <Form.Check label="Option two is disabled" type="radio" disabled name="radios-example" />
      </Form.Group>

      <Form>
        <Form.Check inline label="1" type="radio" name="radios-example-2" />
        <Form.Check inline label="2" type="radio" name="radios-example-2" />
        <Form.Check inline label="3" type="radio" name="radios-example-2" disabled />
      </Form>
    </Card.Body>
  </Card>
);
...
const Switches = () => (
  <Card>
    ...
    <Card.Body>
      <Form.Check type="switch" id="exampleCustomSwitch" name="customSwitch" label="Toggle this switch element" />
      <Form.Check type="switch" id="exampleCustomSwitch1" label="Disabled switch element" disabled />
    </Card.Body>
  </Card>
);
...
const Selects = () => (
  <Card>
    ...
    <Card.Body>
      <Form.Select id="exampleCustomSelect" name="customSelect" className="mb-3">
      ...
      <Form.Select id="exampleCustomSelectMultiple" name="customSelectMultiple" multiple>
        <option value="">Open this select menu</option>
        <option>One</option>
        <option>Two</option>
        <option>Three</option>
  ...
  <Card>
    ...
    <Card.Body>
      <Form.Group className="mb-3">
        ...
        <Form.Control type="text" name="disabledInput" id="disabledInput" placeholder="Disabled input" disabled />
      </Form.Group>
      <Form.Group className="mb-3">
...
const ReadOnly = () => (
  <Card>
    ...
    <Card.Body>
      <Form.Control type="text" name="readonlyInput" id="readonlyInput" placeholder="Readonly input" readOnly />
    </Card.Body>
  </Card>
);

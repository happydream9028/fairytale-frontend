      ...
      <Row>
        <Col lg="6">
          <InputGroup className="mb-3">
            ...
            <FormControl aria-label="Text input with checkbox" placeholder="Checkbox" />
          </InputGroup>
        </Col>
        <Col lg="6">
          <InputGroup>
            <InputGroup.Radio aria-label="Radio button for following text input" />
            <FormControl aria-label="Text input with radio button" placeholder="Radio" />
          </InputGroup>
        </Col>
      </Row>
    </Card.Body>
  ...
  <Card>
    ...
    <Card.Body>
      ...
      <InputGroup className="mb-3">
        ...
        <DropdownButton variant="secondary" title="Dropdown" id="input-group-dropdown-2" align="end">
          <Dropdown.Item href="#">Action</Dropdown.Item>
          <Dropdown.Item href="#">Another action</Dropdown.Item>
          <Dropdown.Item href="#">Something else here</Dropdown.Item>
          <Dropdown.Divider />
...
const SegmentedButtons = () => (
  <Card>
    ...
    <Card.Body>
      <InputGroup className="mb-3">
        <SplitButton variant="secondary" title="Action" id="segmented-button-dropdown-1">
          <Dropdown.Item href="#">Action</Dropdown.Item>
          <Dropdown.Item href="#">Another action</Dropdown.Item>
          <Dropdown.Item href="#">Something else here</Dropdown.Item>
          <Dropdown.Divider />
      ...
      <InputGroup className="mb-3">
        <FormControl aria-label="Text input with dropdown button" />
        <SplitButton variant="secondary" title="Action" id="segmented-button-dropdown-2">
          <Dropdown.Item href="#">Action</Dropdown.Item>
          <Dropdown.Item href="#">Another action</Dropdown.Item>
          <Dropdown.Item href="#">Something else here</Dropdown.Item>
          <Dropdown.Divider />

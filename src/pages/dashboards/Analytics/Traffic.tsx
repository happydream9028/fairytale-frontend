...
const Traffic = () => (
  <Card className="flex-fill w-100">
    <Card.Header>
      ...
      <Card.Title className="mb-0">Traffic</Card.Title>
    </Card.Header>
    <Table striped className="my-0">
      <thead>
        <tr>
          ...
          <th className="d-none d-xl-table-cell text-end">Avg. Session Duration</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">27.23%</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-danger">66.76%</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">31.53%</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-danger">52.81%</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">24.83%</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">37.36%</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">38.09%</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">17.09%</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">32.70%</td>

  ...
  return (
    <Card className="flex-fill w-100">
      <Card.Header>
        ...
        <Card.Title className="mb-0">Source / Medium</Card.Title>
      </Card.Header>
        ...
        <div className="align-self-center w-100">
          ...
          <Table className="mb-0">
            ...
            <tbody>
              <tr>
                <td>
                  <FontAwesomeIcon icon={faSquare} className="text-primary" /> Direct
                </td>
              ...
              <tr>
                <td>
                  <FontAwesomeIcon icon={faSquare} className="text-warning" /> Affiliate
                </td>
              ...
              <tr>
                <td>
                  <FontAwesomeIcon icon={faSquare} className="text-danger" /> E-mail
                </td>
              ...
              <tr>
                <td>
                  <FontAwesomeIcon icon={faSquare} className="text-dark" /> Other
                </td>

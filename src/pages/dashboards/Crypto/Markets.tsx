    ...
    <Table size="sm" striped className="my-0">
      ...
      <tbody>
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">+1.52</td>
        </tr>
        <tr>
          <td>XRP</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">+6.10</td>
        </tr>
        <tr>
          <td>DASH</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">+3.00</td>
        </tr>
        <tr>
          <td>STR</td>
          <td className="text-end">0.00002948</td>
          <td className="d-none d-xl-table-cell text-end">58.981</td>
          <td className="d-none d-xl-table-cell text-end text-success">+2.58</td>
        </tr>
        <tr>
          <td>DOGE</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">+0.54</td>
        </tr>
        <tr>
          <td>EOS</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">+0.36</td>
        </tr>
        <tr>
          <td>ZEC</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-danger">-15.52</td>
        </tr>
        <tr>
          <td>MAID</td>
        ...
        <tr>
          ...
          <td className="d-none d-xl-table-cell text-end text-success">+4.19</td>
        </tr>
        <tr>
          <td>STRAT</td>
          <td className="text-end">0.00028587</td>
          <td className="d-none d-xl-table-cell text-end">17.557</td>
          <td className="d-none d-xl-table-cell text-end text-success">+4.40</td>
        </tr>
      </tbody>
    </Table>
  </Card>

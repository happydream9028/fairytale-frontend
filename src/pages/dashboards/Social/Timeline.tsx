  ...
  <Card className="flex-fill">
    <Card.Body>
      <div className="d-flex">
        <img src={avatar5} width="56" height="56" className="rounded-circle me-3" alt="Ashley Briggs" />
          ...
          <div className="d-flex mt-3">
            ...
            <div className="flex-grow-1 ms-3">
              <p className="text-muted">
                <strong>Stacie Hall</strong>: Nam pretium turpis et arcu. Duis arcu tortor, suscipit eget, imperdiet
                nec, imperdiet iaculis, ipsum. Sed aliquam ultrices mauris. Integer ante arcu, accumsan a, consectetuer
      ...
      <hr />
      <div className="d-flex">
        <img src={avatar1} width="56" height="56" className="rounded-circle me-3" alt="Chris Wood" />
        <div className="flex-grow-1 ms-3">
      ...
      <hr />
      <div className="d-flex">
        <img src={avatar2} width="56" height="56" className="rounded-circle me-3" alt="Carl Jenkins" />
        <div className="flex-grow-1 ms-3">

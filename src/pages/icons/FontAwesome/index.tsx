...
const Icon = ({ icon }: IconType) => (
  <Col md="6" lg="3">
    <div className="mb-2">
      <FontAwesomeIcon className="align-middle me-2" icon={icon.icon} fixedWidth />
    ...
    <Container fluid className="p-0">
      ...
      <Card>
        <Card.Header>
          ...
          <h6 className="card-subtitle text-muted">The web’s most popular icon set and toolkit</h6>
        </Card.Header>
        <Card.Body>
          <div className="mb-3">

...
const HoverableRows = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">
        Add <code>hover</code> to enable a hover state on table rows within a <code>&#x3C;tbody&#x3E;</code>.
      </h6>
    </Card.Header>
    <Table striped hover>
      <thead>
      ...
      <tbody>
        <tr>
          <td>
            <img src={avatar4} width="48" height="48" className="rounded-circle me-2" alt="Avatar" /> Stacie Hall
          </td>
          <td>864-348-0485</td>
          <td>June 21, 1961</td>
        </tr>
        <tr>
          <td>
            <img src={avatar1} width="48" height="48" className="rounded-circle me-2" alt="Avatar" /> Chris Wood
          </td>
          <td>914-939-2458</td>
          <td>May 15, 1948</td>
        </tr>
        <tr>
          <td>
            <img src={avatar2} width="48" height="48" className="rounded-circle me-2" alt="Avatar" /> Carl Jenkins
          </td>
          <td>704-993-5435</td>
        ...
        <tr>
          <td>
            <img src={avatar3} width="48" height="48" className="rounded-circle me-2" alt="Avatar" /> Bertha Martin
          </td>
          <td>765-382-8195</td>
          <td>April 2, 1971</td>
        </tr>
...
const ContextualClasses = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">Use contextual classes to color table rows or individual cells.</h6>
    </Card.Header>
    <Table>
      <thead>
        <tr>
...
const ResponsiveTable = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">
        Across every breakpoint, use <code>responsive</code> for horizontally scrolling tables.
      </h6>
    </Card.Header>
    <Table responsive>
      <thead>

    ...
    <Card>
      <Card.Header>
        ...
        <h6 className="card-subtitle text-muted">
          Here’s a carousel with slides only. Note the presence of the <code>.d-block</code> and <code>.w-100</code> on
  ...
  return (
    <Card>
      <Card.Header>
        ...
        <h6 className="card-subtitle text-muted">Adding in the previous and next controls.</h6>
      </Card.Header>
      <Card.Body className="pt-0">

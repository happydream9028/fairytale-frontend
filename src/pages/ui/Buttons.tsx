...
import { faCheck, faExclamation, faGlobeAmericas, faInfo, faTimes } from "@fortawesome/free-solid-svg-icons";
...
const BasicButtons = () => (
  <Card>
    ...
    <Card.Body className="text-center">
      ...
      <div>
        {colors.map((color, index) => (
          <Button key={index} variant={color.value} className="me-1 mb-1" disabled>
            {color.name}
          </Button>
        ))}
      </div>
...
const RoundedButtons = () => (
  <Card>
    ...
    <Card.Body className="text-center">
      <div className="mb-3">
        {colors.map((color, index) => (
          <Button key={index} variant={color.value} className="btn-pill me-1 mb-1">
            {color.name}
          </Button>
        ))}
      </div>
      <div>
        {colors.map((color, index) => (
          <Button key={index} variant={color.value} className="btn-pill me-1 mb-1" disabled>
            {color.name}
          </Button>
        ))}
      </div>
...
const OutlineButtons = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">Buttons without background color.</h6>
    </Card.Header>
    <Card.Body className="text-center">
      <div className="mb-3">
        {colors.map((color, index) => (
          <Button key={index} variant={`outline-${color.value}`} className="me-1 mb-1">
            {color.name}
          </Button>
        ))}
      </div>
      <div>
        {colors.map((color, index) => (
          <Button key={index} variant={`outline-${color.value}`} className="me-1 mb-1" disabled>
            {color.name}
          </Button>
        ))}
      </div>
...
const SquareButtons = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">Buttons without border radius.</h6>
    </Card.Header>
    <Card.Body className="text-center">
      <div className="mb-3">
        {colors.map((color, index) => (
          <Button key={index} variant={color.value} className="me-1 mb-1 btn-square">
            {color.name}
          </Button>
        ))}
      </div>
      <div>
        {colors.map((color, index) => (
          <Button key={index} variant={color.value} className="me-1 mb-1 btn-square" disabled>
            {color.name}
          </Button>
        ))}
      </div>
...
const IconButtons = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">Default Bootstrap buttons with icons.</h6>
    </Card.Header>
    <Card.Body className="text-center">
      <div className="mb-3">
    ...
    <Card.Body className="text-center">
      <div className="mb-3">
        ...
        <Button variant="dribbble" className="me-1 mb-1">
          <FontAwesomeIcon icon={faDribbble} className="align-middle" /> Dribbble
        </Button>
        ...
        <Button variant="instagram" className="me-1 mb-1">
          <FontAwesomeIcon icon={faInstagram} className="align-middle" /> Instagram
        </Button>
        <Button variant="pinterest" className="me-1 mb-1">
          <FontAwesomeIcon icon={faPinterest} className="align-middle" /> Pinterest
        </Button>
        ...
        <Button variant="bitbucket" className="me-1 mb-1">
          <FontAwesomeIcon icon={faBitbucket} className="align-middle" /> Bitbucket
        </Button>
      </div>
      <div>
        <Button variant="facebook" className="me-1 mb-1">
...
const ButtonDropdowns = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">Dropdowns styles with buttons.</h6>
    </Card.Header>
    <Card.Body className="text-center">
      <div className="mb-3">
        {colors.map((color, index) => (

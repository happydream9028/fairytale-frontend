    ...
    <Tab.Container id="left-tabs-example" defaultActiveKey="first">
      ...
      <Tab.Content>
        <Tab.Pane eventKey="first">
          ...
          <p>
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor tellus eget
            condimentum rhoncus. Aenean massa. Cum sociis natoque penatibus et magnis neque dis parturient montes,
...
interface TabsWithIconLabelType {
  name: string;
  className?: string;
}

const TabsWithIconLabel = ({ name, className }: TabsWithIconLabelType) => (
  <div className={"tab " + className}>
    <Tab.Container id="left-tabs-example" defaultActiveKey="first">
      <Nav variant="tabs">
        <Nav.Item>
  ...
  <React.Fragment>
    ...
    <Container fluid className="p-0">
      ...
      <Row>
        ...
        <Col lg="6">
          <TabsWithIconLabel name="Colored vertical icon" className="tab-danger tab-vertical" />
        </Col>
      </Row>
    </Container>
  </React.Fragment>

      ...
      <Card.Body className="text-center">
        ...
        {colors.map((color, index) => (
          <React.Fragment key={index}>
            ...
            <Modal show={openModals[index]} onHide={() => toggle(index)} centered>
    ...
    <Card>
      ...
      <Card.Body className="text-center">
        ...
        {sizes.map((size: any, index: any) => (
          <React.Fragment key={index}>
            <Button variant="primary" onClick={() => toggle(index)} className="me-1">
              {size.name}
            </Button>
            <Modal show={openModals[index]} onHide={() => toggle(index)} size={size.value}>

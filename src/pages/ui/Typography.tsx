...
const Headings = () => (
  <Card>
    ...
    <Card.Body>
      ...
      <p className="text-muted">
        Etiam rhoncus. Maecenas tempus, tellus condimentum rhoncus, sem quam libero, sit amet adipiscing sem neque sed
        ipsum. Nam quam nunc, vel.
      </p>
...
const InlineText = () => (
  <Card>
    <Card.Header>
      <Card.Title>Inline text</Card.Title>
    ...
    <Card.Body>
      ...
      <p>
        <ins>This line of text can be treated as an addition to the document.</ins>
      </p>
      <p>
...
const ListUnordered = () => (
  <Card>
    <Card.Header>
      <Card.Title>List unordered</Card.Title>
...
const ListOrdered = () => (
  <Card>
    <Card.Header>
      <Card.Title>List ordered</Card.Title>

...
const DefaultAlerts = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">Alerts with contextual background color.</h6>
    </Card.Header>
    <Card.Body>
...
const IconAlerts = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">Alerts with icon and background color.</h6>
    </Card.Header>
    <Card.Body>
      {colors.map((color, key) => (
        <Alert variant={color} key={key} dismissible>
...
const OutlineAlerts = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">Alerts with contextual icon background.</h6>
    </Card.Header>
    <Card.Body>
      {colors.map((color, key) => (
...
const ColouredOutlineAlerts = () => (
  <Card>
    <Card.Header>
      ...
      <h6 className="card-subtitle text-muted">Alerts with contextual outline color.</h6>
    </Card.Header>
    <Card.Body>
      {colors.map((color, key) => (
        <Alert variant={color} className="alert-outline-coloured" key={key} dismissible>
          <div className="alert-icon">
            <FontAwesomeIcon icon={faBell} fixedWidth />
          </div>
          <div className="alert-message">

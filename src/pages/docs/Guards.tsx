...
const Intro = () => (
  <div className="mb-5">
    <h3>Introduction</h3>
    <p className="text-lg">Guards can be used to protect private or public routes based on the current user role.</p>
  </div>
);
...
const GuestGuard = () => (
  <div className="mb-5">
    <h3>Guest Guard</h3>
    <p className="text-lg">The GuestGuard component can be used to protect a route from authenticated users.</p>

...
const HowToAddRoutes = () => (
  <div className="mb-5">
    ...
    <p className="text-lg">
      Open <code>/src/routes.js</code> and add your new route to the <code>routes</code> variable. The example below
      will result in the <code>{`<NewPage />`}</code> element being called on the{" "}
...
const HowToNavigateProgrammatically = () => (
  <div className="mb-5">
    ...
    <p className="text-lg">
      The example code below includes an example on how to navigate programmatically using the <code>useNavigate</code>{" "}
      hook.
    </p>

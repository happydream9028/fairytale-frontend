...
const Intro = () => (
  <div className="mb-5">
    ...
    <p className="text-lg">
      ...
      <a href="https://github.com/axios/axios" target="_blank" rel="noreferrer noopener">
        Axios
      </a>{" "}
      for making XMLHttpRequests from the browser.{" "}
      <a href="https://github.com/ctimmerm/axios-mock-adapter#readme" target="_blank" rel="noreferrer noopener">
        Axios Mock Adapter
      </a>{" "}

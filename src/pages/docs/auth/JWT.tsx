...
const QuickStart = () => (
  <div className="mb-5">
    <h3>Quick start</h3>
    <p className="text-lg">Follow these steps if you want to enable JWT authentication in your application.</p>
...
function App() {
  return (
    ...
    <p className="text-lg">
      Enable JWT's <code>useAuth</code> hook in <code>/src/hooks/useAuth.js</code>.
    </p>
...
const HowToUse = () => (
  <div className="mb-5">
    <h3>How to use</h3>
    <p className="text-lg">
      Learn how to use JWT authentication. There are multiple examples included, including sign in, sign up and sign
      out.
    </p>

...
const Intro = () => (
  <div className="mb-5">
    <h3>Introduction</h3>
    <p className="text-lg">
      Amazon Cognito lets you add user sign-up, sign-in, and access control to your web and mobile apps quickly and
      easily. Amazon Cognito scales to millions of users and supports sign-in with social identity providers, such as
...
function App() {
  return (
    ...
    <p className="text-lg">
      Enable Cognito's <code>useAuth</code> hook in <code>/src/hooks/useAuth.js</code>.
    </p>
...
const HowToUse = () => (
  <div className="mb-5">
    <h3>How to use</h3>
    <p className="text-lg">
      Learn how to use Cognito authentication. There are multiple examples included, including sign in, sign up and sign
      out.
    </p>

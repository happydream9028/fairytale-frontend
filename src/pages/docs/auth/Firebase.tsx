...
const Intro = () => (
  <div className="mb-5">
    ...
    <p className="text-lg">
      ...
      users to your app. It supports authentication using passwords, phone numbers, popular federated identity providers
...
const QuickStart = () => (
  <div className="mb-5">
    <h3>Quick start</h3>
    <p className="text-lg">Follow these steps if you want to enable Firebase authentication in your application.</p>
...
function App() {
  return (
    ...
    <p className="text-lg">
      Enable Firebase's <code>useAuth</code> hook in <code>/src/hooks/useAuth.js</code>.
    </p>
...
const HowToUse = () => (
  <div className="mb-5">
    <h3>How to use</h3>
    <p className="text-lg">
      Learn how to use Firebase authentication. There are multiple examples included, including sign in, sign up and
      sign out.
    </p>

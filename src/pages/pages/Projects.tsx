...
const Project = ({ name, state, color, percentage, description, image }: ProjectType) => (
  <Card>
    ...
    <Card.Body className="px-4 pt-2">
      ...
      <img src={avatar3} width="28" height="28" className="rounded-circle me-2" alt="Avatar" />
      <img src={avatar2} width="28" height="28" className="rounded-circle me-2" alt="Avatar" />
      <img src={avatar1} width="28" height="28" className="rounded-circle me-2" alt="Avatar" />
    </Card.Body>
    <ListGroup variant="flush">
      <ListGroup.Item className="px-4 pb-4">
        ...
        <ProgressBar className="progress-sm" now={parseFloat(percentage)} />
      </ListGroup.Item>
    </ListGroup>
  </Card>
);

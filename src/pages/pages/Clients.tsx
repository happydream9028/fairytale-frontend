    ...
    <Card.Body>
      <Table className="mb-0">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <img src={avatar1} width="32" height="32" className="rounded-circle my-n1" alt="Avatar" />
            </td>
            <td>Ashton Cox</td>
          ...
          <tr>
            <td>
              <img src={avatar4} width="32" height="32" className="rounded-circle my-n1" alt="Avatar" />
            </td>
          ...
          <tr>
            <td>
              <img src={avatar2} width="32" height="32" className="rounded-circle my-n1" alt="Avatar" />
            </td>
          ...
          <tr>
            <td>
              <img src={avatar5} width="32" height="32" className="rounded-circle my-n1" alt="Avatar" />
            </td>
            <td>Gavin Cortez</td>
            <td>Red Robin Stores</td>
...
const Single = () => (
  <Card>
    <Card.Header>
      <Card.Title className="mb-0">Angelica Ramos</Card.Title>
    </Card.Header>
    <Card.Body>
      <Row className="g-0">
        <Col sm="3" xl="12" className="col-xxl-3 text-center">
          <img src={avatar3} width="64" height="64" className="rounded-circle mt-2" alt="Angelica Ramos" />
        </Col>

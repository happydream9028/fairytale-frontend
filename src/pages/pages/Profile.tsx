  ...
  <Card>
    ...
    <Card.Body>
      ...
      <ul className="list-unstyled mb-0">
        ...
        <li className="mb-1">
          <Briefcase width={14} height={14} className="me-1" /> Works at <Link to="/dashboard/default">GitHub</Link>
        </li>
        <li className="mb-1">
          <MapPin width={14} height={14} className="me-1" /> From <Link to="/dashboard/default">Boston</Link>
        </li>
      </ul>
    </Card.Body>
    <hr className="my-0" />
  ...
  <Card>
    ...
    <Card.Body>
      <div className="d-flex">
        <img src={avatar5} width="36" height="36" className="rounded-circle me-2" alt="Ashley Briggs" />
      ...
      <hr />
      <div className="d-flex">
        <img src={avatar1} width="36" height="36" className="rounded-circle me-2" alt="Chris Wood" />
        <div className="flex-grow-1">
          <small className="float-end text-navy">30m ago</small>
          <strong>Chris Wood</strong> posted something on <strong>Stacie Hall</strong>'s timeline
          <br />
      ...
      <hr />
      <div className="d-flex">
        <img src={avatar4} width="36" height="36" className="rounded-circle me-2" alt="Stacie Hall" />
        <div className="flex-grow-1">
      ...
      <hr />
      <div className="d-flex">
        <img src={avatar2} width="36" height="36" className="rounded-circle me-2" alt="Carl Jenkins" />
        <div className="flex-grow-1">
          <small className="float-end text-navy">3h ago</small>
          <strong>Carl Jenkins</strong> posted two photos on <strong>Stacie Hall</strong>'s timeline
          <br />

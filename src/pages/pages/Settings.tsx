        ...
        <Row>
          <Col md="8">
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" id="inputUsername" placeholder="Username" />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label htmlFor="inputBio">Biography</Form.Label>
              <Form.Control as="textarea" id="inputBio" placeholder="Tell something about yourself" />
            </Form.Group>
          </Col>
          <Col md="4">
    ...
    <Card.Body>
      <Form>
        <Row>
          <Col md={6}>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="text" id="firstName" placeholder="First name" />
            </Form.Group>
          </Col>
          <Col md={6}>
            <Form.Group className="mb-3">
              <Form.Label htmlFor="lastName">Last name</Form.Label>
              <Form.Control type="text" name="text" id="lastName" placeholder="Last name" />
            </Form.Group>
          </Col>
        </Row>
        <Form.Group className="mb-3">
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control type="text" name="address" id="address" placeholder="1234 Main St" />
        </Form.Group>
        <Form.Group className="mb-3">
          <Form.Label htmlFor="address2">Address 2</Form.Label>
          <Form.Control type="text" name="address2" id="address2" placeholder="Apartment, studio, or floor" />
        </Form.Group>
        <Row>
          <Col md={6}>
            <Form.Group className="mb-3">

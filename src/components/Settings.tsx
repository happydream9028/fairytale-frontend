  ...
  return (
    <div ref={innerRef} className={`settings js-settings ${isOpen ? "open" : ""}`}>
      <div className="settings-toggle">
        ...
        <a className="settings-toggle-option" title="Documentation" href="/docs" target="_blank">
          ...
          <div className="settings-body">
            <Alert variant="primary">
              <div className="alert-message">
                <strong>Hey there!</strong> Set your own customized style below. Choose the ones that best fits your
                needs.
              </div>
            </Alert>
            ...
            <div className="mb-3">
              ...
              <span className="d-block text-muted mb-2">The perfect color mode for your app.</span>
            ...
            <div className="mb-3">
              ...
              <span className="d-block text-muted mb-2">Toggle the position of the sidebar.</span>
              <div>
            ...
            <div className="mb-3">
              ...
              <span className="d-block text-muted mb-2">Change the behavior of the sidebar.</span>
              <div>
            ...
            <div className="mb-3">
              ...
              <span className="d-block text-muted mb-2">Toggle container layout system.</span>
              <div>
